...
/** Сверка фото с планом на сервере команды (26.09): `status` — confirmed | not_confirmed | review |
...
/** Одна запись GET /photos сервера команды: id (= server_id из POST /api/foreman/shots), имя файла
